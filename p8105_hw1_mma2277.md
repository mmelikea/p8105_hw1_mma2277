...
of the recording). There are 358 rows and 15 columns present in this
dataset. The mean temperature in F is 40.
...
beginning of the January 2013 to the end of January 2017, temperatures
increased. The relationship between time_hour and temperature appears to
be a positive linear relationship. Also, humidity tends to increase with
