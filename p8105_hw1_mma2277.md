...
##### From factor to numeric: When we run it, we get a mean, because our factor variables were converted to numeric variables. Levels become numbers. We did not get the mean before because the variables were not converted to numeric, it was considered character variables. Factor variables can be converted to numeric variables. The mean is 0.5.
